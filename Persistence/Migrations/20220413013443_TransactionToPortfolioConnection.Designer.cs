...
namespace Persistence.Migrations
{
    ...
    [Migration("20220413013443_TransactionToPortfolioConnection")]
    partial class TransactionToPortfolioConnection
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("CoinBaseRefreshToken")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Portfolio", b =>
                {
                    b.HasOne("Domain.Entities.Crypto", "Crypto")
                        .WithMany()
